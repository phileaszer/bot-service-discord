(() => {
  ...
  const en = {
    ...
    'Les dossiers sont le système de tickets de Sentinel : chaque demande ouvre un salon privé entre le membre et l’équipe autorisée.': 'Dossiers are Sentinel tickets: each request opens a private channel between the member and the authorized team.',
    'Publier le bureau d’accueil': 'Publish the reception desk',
    'Envoie le panneau qui permet aux membres d’ouvrir un dossier Sentinel, c’est-à-dire un ticket privé avec le staff.': 'Sends the panel members use to open a Sentinel dossier, meaning a private ticket with the staff.',
