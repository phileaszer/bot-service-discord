(() => {
  ...
  Object.assign(en, {
    ...
    'Sauvegardes': 'Backups',
    'La base SQLite est sauvegardée pour éviter une perte de données après un incident. Ces sauvegardes restent internes et ne sont pas affichées publiquement.': 'The SQLite database is backed up to prevent data loss after an incident. These backups stay internal and are not publicly displayed.',
    ...
    'Voir tout': 'View all',
    'Sauvegarde SQLite': 'SQLite backup',
    'Dernière sauvegarde de la base Sentinel.': 'Latest Sentinel database backup.',
  ...
  Object.assign(en, {
    ...
    'Dernière relance': 'Last restart',
    "Cette date change quand l'hébergeur redémarre Sentinel ou le dashboard.": 'This date changes when the host restarts Sentinel or the dashboard.',
    'Dernière vérification': 'Latest check',
    'Contrôle en direct effectué par cette page.': 'Live check performed by this page.',
    'En attente': 'Waiting',
  ...
  Object.assign(en, {
    ...
    'Version actuellement utilisée par Sentinel.': 'Version currently used by Sentinel.',
