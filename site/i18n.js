(() => {
  ...
  const en = {
    ...
    'Envoie dans le salon choisi les boutons que les membres utiliseront pour prendre ou finir leur service.': 'Sends the buttons members use to start or end duty in the selected channel.',
  ...
  Object.assign(en, {
    ...
    'Couper les nouveautés': 'Disable updates',
    'Publier un salon statut avec l’état du bot et, si activé, les nouveautés officielles': 'Publish a status channel with bot health and, if enabled, official updates',
  ...
  Object.assign(en, {
    ...
    'Panneau de service': 'Duty panel',
    'Publie ou republie les boutons de service dans le salon de ton choix.': 'Publish or republish the duty buttons in the channel of your choice.',
    'Salon de publication': 'Publishing channel',
    'Salon dans lequel Sentinel enverra les boutons utilisés pour prendre ou finir son service.': 'Channel where Sentinel will send the buttons used to start or end duty.',
