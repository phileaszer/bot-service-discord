(() => {
  ...
  const en = {
    ...
    'Envoie le panneau qui permet aux membres d’ouvrir un dossier Sentinel, puis d’échanger en privé avec le staff.': 'Sends the panel members use to open a Sentinel dossier, then talk privately with the staff.',
    'Publier le bureau': 'Publish desk',
    'À quoi ça sert ?': 'What is it for?',
    'Un dossier sert pour une demande support, un signalement, une plainte, une demande administrative ou un bug Sentinel.': 'A dossier is used for support requests, reports, complaints, administrative requests, or Sentinel bugs.',
    'Quand un membre ouvre un dossier, Sentinel crée un salon privé, garde le demandeur, les rôles autorisés et les intervenants dans le même espace, puis peut générer un compte rendu.': 'When a member opens a dossier, Sentinel creates a private channel, keeps the requester, authorized roles, and participants in the same space, then can generate a transcript.',
