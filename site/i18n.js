(() => {
  ...
  Object.assign(en, {
    ...
    'Version active du deploiement actuellement servi par le dashboard.': 'Active version of the deployment currently served by the dashboard.',
    ...
    'Dashboard accessible depuis Railway.': 'Dashboard reachable from Railway.',
    'Impossible de lire le statut en direct.': 'Unable to read live status.',
    'La page est chargée, mais l’API de statut ne répond pas.': 'The page is loaded, but the status API is not responding.',
